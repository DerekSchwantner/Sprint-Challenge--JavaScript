...
console.log('the raptors diet was', raptor.diet);

// How long was a stegosaurus?
console.log('the stegosaurus was', steg.length);

// What time period did tyrannosaurus live in?
console.log('the tyrannosaurus lived during the', tRex.period);
...
// not sure if the sort(); stand alone function was restricted so I did both. Below is the full alphabetical sort written out. Both work.

// var sortedUniversities = universities.sort(function (a, b) {
//     if (a < b) return -1;
...
// OR console.log(sortedUniversities)
